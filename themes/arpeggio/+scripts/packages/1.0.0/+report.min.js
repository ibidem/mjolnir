...
{};app.acctg.TransactionOperation={};app.acctg.Check={};app.acctg.CheckExpense={};app.acctg.Deposit={};app.acctg.DepositPayment={};app.acctg.Invoice={};app.acctg.InvoicePayment={};app.acctg.InvoiceExpense={};app.acctg.Report={};app.acctg.ReportOptions={}})(window.App,window.Backbone,window.jQuery,window.Mjolnir,window.mjb,window.pusher,window.moment,window._);(function(app,_){var ns=".app-report-options-",ens=".acctg_ReportOptions";app.acctg.ReportOptions.Model=app.Model.extend({});app.acctg.ReportOptions.Model.View=app.View.extend({options:{windows:app.windows},template:app.template("acctg-reports-ReportOptions"),render:function(){var self=this;console.log("render: acctg.ReportOptions.Model");self.markup(self.template(self));self.setupcontrols();return self},setupcontrols:function(){var self=this;self.$(ns+"dates").on("click"+ens,function(){self.add_expense()})}})})(window.App,
window._);(function(app,_){var ns=".app-report-",ens=".acctg_Report";app.acctg.Report.Model=app.Model.extend({});app.acctg.Report.Model.View=app.View.extend({options:{windows:app.windows},render:function(){var self=this;console.log("render: acctg.Report.Model");self.setupcontrols();return self},setupcontrols:function(){var self=this}})})(window.App,window._);(function(app){app.acctg.ReportOptions.bootup=function(conf){console.log("bootup: acctg.ReportOptions");var ReportOptions=app.acctg.ReportOptions;var $view=app.$(conf.el);var bootup=function(){var rom=new ReportOptions.Model,rov=new ReportOptions.Model.View({model:rom});$view.html("");$view.append(rov.render().el);rom.on("reboot",function(){rov.remove();bootup()})};bootup()};$(function(){app.acctg.ReportOptions.bootup({el:".app-reports-Report-Options"})})})(window.App);(function(app){app.acctg.Report.bootup=function(conf){console.log("bootup: acctg.Report");var Report=app.acctg.Report;var bootup=function(){var bsm=new Report.Model,bsv=new Report.Model.View({model:bsm,el:conf.el});bsv.render();bsm.on("reboot",function(){bsv.remove();bootup()})};bootup()};$(function(){app.acctg.Report.bootup({el:".app-reports-Report"})})})(window.App);
