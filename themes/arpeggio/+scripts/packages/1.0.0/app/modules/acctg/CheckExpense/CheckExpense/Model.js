...
////////////////////////////////////////////////////////////////////////////////
	...
	app.acctg.CheckExpense.Model = app.Model.extend({

		urlRoot: app.api + 'acctg-check-expenses',
...
////////////////////////////////////////////////////////////////////////////////
	...
	app.acctg.CheckExpense.Model.View = app.View.extend({
		...
		template: app.template('acctg-procedures-CheckExpense'),

		render: function () {
			var self = this;
			console.log('render: acctg.CheckExpense.Model.View');
